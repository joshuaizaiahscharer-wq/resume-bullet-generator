...
function renderBlogListPage(siteUrl, posts = blogPosts) {
  ...
  const blogListJsonLd = JSON.stringify({
    ...
    "@type": "Blog",
    name: "Resume & Career Blog | BulletAI",
    description: "Actionable resume guides, interview tips, career growth strategies, and job-search writing advice to help you land interviews faster.",
    url: siteUrl + "/blog",
    publisher: {
      "@type": "Organization",
      name: "BulletAI",
