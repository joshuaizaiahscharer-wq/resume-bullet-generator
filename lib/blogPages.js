  ...
  return `
    <nav class="blog-nav">
      ...
      <div class="blog-nav-actions">
        ...
        <a href="/blog" class="blog-nav-link blog-nav-link--active">Blog</a>
...
function renderBlogCard(post) {
  ...
  const authorMarkup = post.author
    ? `<span class="blog-card-author">by ${escapeHtml(post.author)}</span>`
    : '';
  return `
  ...
  <body class="blog-body">
    ...
    <main class="blog-main" aria-label="Blog posts">
      <section class="blog-grid">
        ${cardsMarkup || '<p style="text-align:center;color:#64748b;grid-column:1/-1;padding:3rem 1rem;">No posts available yet. Check back soon!</p>'}
      </section>
    </main>
    ...
    <main class="blog-article-main">
      <article class="blog-article" aria-labelledby="post-title">
        <div class="blog-article-meta">
          <span class="blog-card-date">${escapeHtml(formatDate(post.date))}</span>
          ${post.author ? `<span class="blog-article-author">by ${escapeHtml(post.author)}</span>` : ''}
        </div>
