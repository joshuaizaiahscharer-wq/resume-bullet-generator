  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <header className="mb-10 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-lg backdrop-blur sm:p-8">
          ...
          <ul className="grid gap-3 sm:gap-4" aria-label={`Resume bullet examples for ${formattedSlug}`}>
            {bullets.map((bullet, index) => (
              <li
                ...
                className="rounded-xl border border-slate-800 bg-slate-900 p-4 text-sm leading-6 text-slate-200 shadow-sm sm:text-base"
              >
                {bullet}
              </li>
            ))}
        ...
        <section className="mb-10 rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-lg" aria-labelledby="tool-heading">
          ...
          <form className="mt-5 grid gap-3 sm:grid-cols-[1fr_auto]" action="#" onSubmit={(e) => e.preventDefault()}>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
            />
            <button
              type="submit"
        ...
        <nav aria-labelledby="related-pages-heading" className="rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-lg">
